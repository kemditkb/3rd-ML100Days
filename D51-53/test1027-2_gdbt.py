...
var_a =['other','total_payments']
for var_columns in var_a:
...
########### ({'max_depth': 3, 'n_estimators': 60, 'tol': 20}, 0.85)
gdbt = GradientBoostingClassifier(tol=20, subsample=0.75, n_estimators=60, max_features=x_selected.shape[1], 
...
var_key = ['other','long_term_incentive','bonus','exercised_stock_options']
...
sub.to_csv('test1027-2_gdbt.csv', index=False)
